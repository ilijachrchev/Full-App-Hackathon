    ...
    <div className="flex min-h-screen flex-col bg-muted/40">
      <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-background px-6 bg-blue-900">
        ...
        <nav className="ml-auto flex gap-4">
          ...
          <button className="text-sm font-medium text-white p-2">Digital Twin</button>
          <button className="text-sm font-medium text-white p-2" onClick={handleClick}>AI Suggestion</button>
